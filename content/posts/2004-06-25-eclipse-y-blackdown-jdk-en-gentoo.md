...
Detecté un bug con el paquete eclipse-sdk-2.1.3-r3 y la kit jdk de java "blackdown 1.4.1" en Gentoo, y lo [postee](http://bugs.gentoo.org/show_bug.cgi?id=54320).
