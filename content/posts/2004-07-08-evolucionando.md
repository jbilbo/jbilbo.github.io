---
title: Evolucionando…
date: '2004-07-08T05:11:00.000-07:00'
tags:
- Software Libre
---

Aún recuerdo, tampoco hace tanto, cuando utilizaba habitualmente [Slackware](http://www.slackware.com/). Era otra cosa, utilizabas tu software y la noticia, "la actualización", las nuevas versiones, venían cuando salía una nueva versión de tu distribución. Es cierto que podías hacer chanchullos para ir actualizando tal o cuál paquete, con este u otro método, pero la actualización real (glibc nuevas... etc) la hacías cuando subías de versión en la distribución.

Las cosas cambian, proyectos como Debian o FreeBSD con su filosofía de versiones han hecho que el usuario se acostumbré a la noticia de "nueva versión de [programa]" en vez de "nueva versión de [distribución]". Gentoo, Debian, Fedora, Mandrake... todas, aunque siguen sacando CDs de instalación y subiendo de versión, pero ahora ya la mayoría se basan en un sistema de actualización por programas. Y ese es el futuro. Ahora mismo, con SuSE, que es una distribución no preparada para actualización por programas (aunque se puede apt-getear), me doy cuenta que realmente estoy limitado a los rpm que me proporciona la distribución, porque los "externos" aunque se puedan instalar no le gustan mucho a [YaST](http://www.suse.de/es/private/products/suse_linux/i386/yast.html)... además que el proceso es manual (sigh xD) total que se "vive" con los rpm oficiales, con alguno que otro externo (como para gaim, que me niego a "aguantar" con una 0.75) y a base de parches de seguridad. No digo que este tipo de distribuciones no sean adecuados para según que gente...
