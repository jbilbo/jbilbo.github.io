...
Al parecer hay un error en Gentoo al emerger Gnomemeeting 1.00 (recién salido a estable). El fallo está entre la librería pwlib y el soporte ldap (Openldap). El error es este:
...
La solución la podemos encontrar [aquí](http://bugs.gentoo.org/show_bug.cgi?id=45016#c8) y se trata de recompilar openldap, pwlib y gnomemeeting.
